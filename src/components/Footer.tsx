...
import { CLASSIFICATION_LABELS, SITE, TESTS } from '@/lib/content';
...
export function Footer() {
	return (
		<footer className="border-t-2 border-ink bg-ink text-paper">
			<div className="blueprint">
				<div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
					<div className="md:col-span-2">
						...
						<p className="eyebrow mt-2 text-brass">{SITE.tagline}</p>
			...
			<div className="hazard-brass h-1.5 w-full" aria-hidden />
			<div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-5 text-xs text-muted-ink sm:flex-row sm:items-center sm:justify-between sm:px-6">
				<p>
					Modernization concept by That Simple Tech. Demo content — not affiliated with
					or endorsed by National Testing Network or Ergometrics.
				</p>
